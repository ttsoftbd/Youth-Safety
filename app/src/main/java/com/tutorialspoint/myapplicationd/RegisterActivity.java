...
public class RegisterActivity extends AppCompatActivity {
  ...
  /////////////////////////////////////////////
        ...
        if(TextUtils.isEmpty(NameHolder) || (!emailToText.isEmpty() && Patterns.EMAIL_ADDRESS.matcher(emailToText).matches()) || TextUtils.isEmpty(PasswordHolder)) {

            EditTextEmptyHolder = Boolean.TRUE ;
